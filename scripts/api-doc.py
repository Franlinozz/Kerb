...
E = [
    ...
    ("GET", "/v1/exit/:chain/:asset?hours=72", "The exit check (V3-06): the latest post's tick-walk C(1%) against the OKX DEX quote at the same notionals, which bound the capacity, the quote's age, and a summary of the window with a strip of checks. Cache 30 s.", "/v1/exit/196/KOx?hours=72"),
