...
| V2-11 Hardening and cutover (freeze Thu 24 Sep 20:00 UTC) | both | in progress 22 Sep: CI green with E2E required (run 35724078897; the suite against a production build and 42 recorded real API responses); 38 E2E (functional, links, axe on 10 routes in both themes with zero serious or critical); 277 buttons pressed in both themes, 0 dead; secret scan of full history clean (17 live secret values, 0 found); positions feed rate limited; proxy never passes internal errors; every route ISR; Board server-renders its table again. Lighthouse mobile on this loaded VPS: Home 58 to 62, Board 55 to 58, Methodology 74 (a11y 100, best practices 100 everywhere); perf below the 85 target. Cutover not yet done |
