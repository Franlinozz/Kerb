...
| V2-09 Research and Report #2 | both | frontend done 22 Sep (index with Scheduled row and countdown, report page with diverging bars, window strip with real gap positions from `/v1/market-time/:id/gaps`); data half (Report #2) runs Thu 24 Sep after 09:00 UTC. Captures are scheduled in root's crontab (local time, UTC+2): window-start Wed 07:00 UTC, window-watch Thu 05:00 to 09:00 UTC, campaign-pre 06:30 and 06:55, campaign-post 07:05, 07:30 and 08:30, window-end Fri 07:00 UTC; tested under cron's environment 22 Sep |
