...
| OKX.AI marketplace listing | The pack asked for registration by Wed 18:00 UTC; the operator chose to skip it | x402 is live on mainnet with a settled payment; OKX.AI is claimed nowhere | **Operator:** still possible tonight; review takes up to 24 h, so after Thu evening it cannot land before filming |
