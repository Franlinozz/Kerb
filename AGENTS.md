...
Appended 23 Sep 2026 from `docs/v3/AGENTS-V3-ADDENDUM.md`. Where this section conflicts with sections 1 to 12, this section wins. One agent (Claude Code) runs both lanes, by operator instruction; the lane ownership rules below still hold phase by phase.
